package com.globalhack.microwebservice.app.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("globalhackMicrowebservices");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("globalhackMicrowebservices");
        ...
        config.getMapConfigs().put("com.globalhack.microwebservice.app.domain.*", initializeDomainMapConfig(jHipsterProperties));
